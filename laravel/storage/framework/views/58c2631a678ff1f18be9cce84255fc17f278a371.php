            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $loaitin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chitiet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX" align="center">
                                    <td><?php echo e($chitiet->id); ?></td>
                                    <td><?php echo e($chitiet->Ten); ?></td>
                                    <td><?php echo e($chitiet->TenKhongDau); ?></td>
                                    <td><?php echo e($chitiet->TheLoai->Ten); ?></td>
                                    <td class="center"><i class="fa fa-pencil fa-fw"></i><a href="admin/loaitin/sua/<?php echo e($chitiet->id); ?>">Sửa</a></td>
                                    <td class="center">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Bạn muốn xóa Loại Tin: "<?php echo e($chitiet->Ten); ?>"?</p>
                                                    </div>
