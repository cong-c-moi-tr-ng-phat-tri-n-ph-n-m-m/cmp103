...
<head>
    ...
    <!-- Custom CSS -->
    <link href="admin_assetcss/shop-homepage.css" rel="stylesheet">
    <link href="admin_assetcss/my.css" rel="stylesheet">
...
<body>
    ...
    <?php echo $__env->make('block.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->yieldContent('content'); ?>
    
    <?php echo $__env->make('block.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
