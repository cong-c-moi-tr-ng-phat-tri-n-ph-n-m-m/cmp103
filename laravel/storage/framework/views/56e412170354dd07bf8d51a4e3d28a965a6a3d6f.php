    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="font-size: 1.4em;" href="<?php echo e(url('/')); ?>">tinnhanh.net</a>
            </div>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="nav-item dropdown">
                            <a style="cursor: pointer;" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-user fa-fw" style="margin-right: 0.5em;"></i><?php echo e(Auth::user()->name); ?><i style="margin-left: 0.5em;" class="fa fa-caret-down"></i>
                            </a>
